...
The differences are:
  ...
  * This PCB uses a single row of pin headers to enable _vertical_
    mounting (i.e. perpendicular to the parent PCB) using
    right-angle pin headers (credit to
    link:https://www.diystompboxes.com/smfforum/index.php?msg=1312371[RG Keen for the suggestion])
...
== Build Reports
  ...
  * link:https://forum.pedalpcb.com/threads/the-enchanter-custom-timmy-jan-ray.30400/[The Enchanter]
